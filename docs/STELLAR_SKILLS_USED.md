...
Ilgili dosyalar: `Cargo.toml`, `Cargo.lock`, `rust-toolchain.toml`, `contracts/rotating_pool/**`, `docs/plan.md`, future deployment scripts.
...
Ilgili dosyalar: `docs/plan.md`, `contracts/rotating_pool/src/lib.rs`, `contracts/rotating_pool/src/storage.rs`, `contracts/rotating_pool/src/test.rs`, future `scripts/**`.
...
Ilgili dosyalar: `docs/plan.md`, future `backend/**`.
...
Ilgili dosyalar: `docs/plan.md`, future `backend/**`, future `scripts/**`.
...
Ilgili dosyalar: `docs/plan.md`, future contract review docs/logs.
